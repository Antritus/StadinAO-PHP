...
<div class="viesti teksti">
    <h1>Poistetaanko kaikki viestit? Poistutaan <span id="time">4</span> sekunnin päästä</h1>
    <p>Poista viestit painamalla POISTA VIESTIT nappia tai palaa aikasemalle sivulle painamalla PALAA TEHTÄVÄ 39</p>
    <br>
    <a href="../page6.php#tehtava-39"><button class="paluu">Palaa tehtävä 39</button></a>
    <a href="./poista_viestit_callback.php"><button class="paluu">Poista viestit</button></a>
